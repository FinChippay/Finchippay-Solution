 ...
 * Shared SVG icon components — resolves #289.
 * All icons accept an optional `className` prop for sizing/colour.
 */
...
export function NavStarIcon({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2L14.09 8.26L21 9L15.5 14.14L17.18 21L12 17.77L6.82 21L8.5 14.14L3 9L9.91 8.26L12 2Z" fill="currentColor" />
    </svg>
  );
}
