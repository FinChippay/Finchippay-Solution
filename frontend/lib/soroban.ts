...
const ERROR_MESSAGES: Record<number, string> = {
  ...
  6: "Invalid state — the operation is not valid in the item's current state",
  ...
  10: "Already signed — this address has already approved the proposal",
  11: "Insufficient funds — the stream does not have enough deposited funds",
  12: "Contract paused — value-transferring operations are blocked",
  13: "Self-transfer — sender and recipient must be different",
  14: "Batch too large — batch size exceeds the maximum allowed recipients",
  15: "Duplicate signer detected in the signers list",
  16: "Proposal expired — the proposal can no longer be approved",
  17: "Transfer failed — actual balance did not increase by the expected amount",
  18: "Index full — the recipient's escrow index already holds the maximum entries",
  19: "Emergency withdrawal not ready — the activation ledger has not been reached",
  20: "Not an admin signer — the caller is not authorised for this withdrawal",
  21: "Invalid path — the swap path is malformed",
  22: "Slippage exceeded — the swap would return less than the minimum amount out",
  23: "Excessive amount in — the input exceeds the maximum allowed amount",
  24: "Invalid fee bps — the fee exceeds the maximum allowed swap fee",
  25: "Proposal not found — the referenced admin action proposal does not exist",
  26: "Proposal already executed — the admin action proposal has already been executed",
  27: "Release ledger not reached — the yield escrow has not reached its release ledger",
  28: "Reentrant call — a mutating entry point was re-entered mid-flight",
  29: "Stale path — the swap path references stale liquidity or a repeated token",
};
