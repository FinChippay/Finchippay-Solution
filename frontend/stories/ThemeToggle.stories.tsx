...
function ThemeTogglePreview({ initialTheme, initialAccent }: ThemeTogglePreviewProps) {
...
const meta: Meta<typeof ThemeToggle> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Accessible theme selector supporting persistent light, dark, operating-system preferences, and accent colour indication.",
      },
    },
  },
};
