...
echo ""
echo "   Swap functions (Issue #9 / #479) are picked up automatically from the"
echo "   deployed contract's ABI — no separate step is needed. They surface as:"
echo "     client.swapExactTokensForTokens(...)"
echo "     client.swapTokensForExactTokens(...)"
echo "     client.setFeeCollector(...) / client.getFeeCollector()"
echo "     client.setSwapFee(...)      / client.getSwapFee()"
echo ""
